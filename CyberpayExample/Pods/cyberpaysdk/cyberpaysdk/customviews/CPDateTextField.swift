...
public protocol DateTextFieldDelegate: class {
    func dateDidChange(dateTextField: CPDateTextField)
}

@IBDesignable
 public class CPDateTextField: MaterialFilledTextField {
    ...
    public var dateFormat = Format.monthYear
   ...
   public weak var customDelegate: DateTextFieldDelegate?
    ...
    public var year: String {
        get {
            ...
            let splitString = split(string: numbersOnly, format: [2, 2])
            return splitString.count > 1 ? splitString[1] : ""
   ...
   public func numberOnlyString(with string: String) -> String? {
...
extension CPDateTextField {
   ...
   public func split(string: String, format: [Int]) -> [String] {
  ...
  public  func final(day: String, month: String, year: String) -> String {
